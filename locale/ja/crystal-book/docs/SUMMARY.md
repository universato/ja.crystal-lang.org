...
* 仕様
      * [このガイドについて](syntax_and_semantics/README.md)
      * [コメント](syntax_and_semantics/comments.md)
      * [コードのドキュメント化](syntax_and_semantics/documenting_code.md)
...
* チュートリアル
      * [基本](tutorials/basics/README.md)
             ...
             * [変数](tutorials/basics/20_variables.md)
             * [数学関連](tutorials/basics/30_math.md)
             * [文字列](tutorials/basics/40_strings.md)
             * [制御構文](tutorials/basics/50_control_flow.md)
             * [メソッド](tutorials/basics/60_methods.md)
